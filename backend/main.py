...
#         "http://localhost:3000",
#         "http://127.0.0.1:3000",
#         "https://moneystories.netlify.app"
#             ],
#     allow_methods=["*"],
#     allow_headers=["*"],
# )
...
# @app.get("/api/health")
# def health_check():
#     return {"status": "sab jhaaksh hai", "service": "backend"}
    ...
    try:
        ...
        if not data:
            ...
            return {
                ...
                "excelBuffer": None,
                "message": "No financial data found in PDF."
            }
        ...
        if (
            ...
            flat_data_for_excel = data[0]["rows"]
        else:
            flat_data_for_excel = data
